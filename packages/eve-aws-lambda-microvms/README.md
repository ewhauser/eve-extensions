...
> Extracted from [vercel/eve#208](https://github.com/vercel/eve/pull/208), authored by Andrew Barba, and adapted into a standalone package for Eve 0.54.3. This package is licensed under Apache-2.0; see `LICENSE`. See `NOTICE` for upstream attribution and a summary of the packaging changes.
...
This package targets Eve 0.54.3 exactly:

```sh
pnpm add eve@0.54.3 eve-aws-lambda-microvms
```
